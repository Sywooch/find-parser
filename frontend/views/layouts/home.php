...
<!--<div class="wrap">-->
    <?php
    NavBar::begin([
        'brandLabel' => '<img src="/images/icon/logo.ico" class="pull-left" style="margin-top: -15px"/>SISHIK.NET<div class="head-phone" ">0670003078, 0800303078</div>
',
//        'brandLabel' => 'SISHIK.NET',
